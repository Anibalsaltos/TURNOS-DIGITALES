...
<div id="main">
<table>
<tr><td><a href="formularioRepresentanteInsert.php">Nuevo</a></td></tr>
<?php
foreach ($RepresentanteCollectorObj->readRepresentantes() as $c){
  ...
  echo "<td><a href='formularioRepresentanteEditar.php?id=".$c->getIdRepresentante()."'>editar</a></td>";
  echo "<td><a href='eliminar.php?id=".$c->getIdRepresentante()."'>eliminar</a></td>"; 
  echo "</tr>"; 
}
?>
</table>
