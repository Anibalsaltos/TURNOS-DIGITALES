...
<body>
  ...
  <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <table>
              <tr><td><a href="formularioañolectivoinsertar.php" class = "boton">Crear Nuevo año lectivo</a></td></tr>
              <?php
              foreach ($anolectivoCollectorObj->readaano_lectivos() as $c){
                echo "<tr>";
                echo "<td>".$c->getaano_lectivo_id() ."</td>";
                echo "<td>".$c->getdesrcripcion()."</td>";
                echo "<td>".$c->getestado()."</td>";
                echo "<td><a href='formularioañolectivoeditar.php?id=".$c->getano_lectivo_id()."'>Editar</a></td>";
                echo "<td><a href='eliminarañolectivo.php?id=".$c->getano_lectivo_id()."'>Eliminar</a></td>"; 
                echo "</tr>"; 
              }
              ?>
              </table>
